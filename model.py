...
class SelfAttention(nn.Module):
    ...
    def forward(self, x, attn_mask=None):
        ...
        attn=attn.masked_fill(attn_mask,value=float('-inf'))
...
class GPT(nn.Module):
    ...
    def forward(self, word_idx, targets=None):
        ...
        for i in range(self.num_layer):
            out,weights=self.transformer[i](out,attn_mask)
        ...
        out=self.norm(out)
        logits=self.language_model_head(out)
